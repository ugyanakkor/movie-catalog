...
import { Movie, MovieFormProps} from "@/interfaces/movie-catalog.interface.ts";


const API_URL = "https://crudcrud.com/api/9f191d6b2a8449339f3047f858eaca3a/movies";
const App = () => {
            ...
            {filteredMovies.map((movie) => (
                <Card key={movie._id} className="shadow-lg">
                  <CardContent>
                    ...
                    <p className="text-sm text-gray-500">Age limit: {movie.ageLimit}+</p>
                    <div className="mt-4 flex justify-between">
                      <Button onClick={() => null}>Edit</Button>
                      <Button
                          variant="destructive"
                          onClick={() => {
                            if(movie._id) {deleteMovie(movie._id)}
                          }}
                      >
                        Delete
                      </Button>
